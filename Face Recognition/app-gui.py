...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button1 = tk.Button(self, text="   Add a User  ", fg="#ffffff", bg="#263945",command=lambda: self.controller.show_frame("PageOne"))
            button2 = tk.Button(self, text="   Check a User  ", fg="#ffffff", bg="#673942",command=lambda: self.controller.show_frame("PageTwo"))
